...
import { getMarca, getCategoria, getImpuesto, getTalla, getColor } from "../services/catalogo.service";
...
function Articulos (){
    ...
    const guardarArticulo = async (e) => {
        ...
        try{
            ...
            setDataArticulos({
                articulo: {marca: "", categoria: "", impuestos: "", nombre: "", slug: "", 
    ...
    const actualizarFormArticulos = (e) => {
        ...
        const camposArticulo = ["marca", "categoria", "impuestos", "nombre", "slug", "descripcion", "precio_base", "estado"];
    ...
    const editarArticulo = (objArticulo) => {
        setDataArticulos({
            ...objArticulo,
            articulo: objArticulo.articulo.idvararticulo || objArticulo.articulo
        });
        abrirModalArticulo();
    }
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1">
                ...
                <div className="flex items-center justify-start sm:justify-end mt-5">
                    <button
                        type="button"
                ...
                {modalArticulos && (
                    <div className="fixed inset-0 z-100 bg-slate-900/40 backdrop-blur-sm flex justify-center items-center">
                        <div className="bg-white border border-slate-200/80 shadow-sm rounded-xl w-full max-w-4xl h-auto max-h-[85vh] flex flex-col overflow-hidden">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-5 md:gap-5">
                                            ...
                                            <div className="relative mt-2">
                                                ...
                                                <input 
                                                    ...
                                                    name="precio_base"
                                                    onChange={actualizarFormArticulos}
                                                    value={dataArticulos.articulo.precio_base}
                                                    className="w-full bg-slate-50/30 rounded-lg border border-slate-200 px-3.5 py-2.5 text-sm text-slate-800 outline-none transition-all focus:border-blue-500 focus:ring-4 focus:ring-emerald-500/10 focus:bg-white"
                                                    placeholder=""
                                                />
                                            </div>
                                            ...
                                            <div className="relative mt-2">
                                                ...
                                                <input 
                                                    type="number" 
                                                    name="precio_extra"
                                                    value={dataArticulos.precio_extra}
                                                    onChange={actualizarFormArticulos}
                                                    className="w-full bg-slate-50/30 rounded-lg border border-slate-200 px-3.5 py-2.5 text-sm text-slate-800 outline-none transition-all focus:border-blue-500 focus:ring-4 focus:ring-emerald-500/10 focus:bg-white"
                                                />
                                            </div>
                ...
                <div className="px-6 pb-2 mt-10">
                    ...
                    <table className="w-full text-sm border-separate border-spacing-0 rounded-xl overflow-hidden shadow-sm border border-gray-200/90 mt-5">
                        <thead>
                            {/* CAMBIO: Eliminamos el degradado. Usamos un fondo gris/azul institucional muy serio. El azul de tu marca se usa en una línea sutil inferior */}
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {variantes?.map((data, index) => (
                                <tr
                                    /* CAMBIO: El hover ahora usa un azul/gris ultra lavado (slate-50/70). No satura el ojo y se ve corporativo */
                                ...
                                >
                                    <td className="px-5 py-4 align-top">
                                        ...
                                        {/* Incorporación de tus colores en los identificadores de variantes */}
                                    ...
                                    <td className="px-5 py-4 align-top">
                                        {/* Tu color verde aplicado elegantemente en la categoría */}
                                    ...
                                    <td className="px-5 py-4 align-top">
                                        ...
                                        <p className="mt-1.5">
                                            {/* El stock crítico o positivo usa variaciones sutiles de verde/ámbar/rojo estándar de la industria */}
                                    ...
                                    <td className="px-5 py-4 align-top">
                                        {/* Botones interactivos que reaccionan con tus colores exactos al pasar el cursor */}
